...
public class Calculator020DivideTest {
	...
	@Test
	/**
	 * This testmethod tests the method divide in the class Calculator with positive random generated numbers 0-100
	 */
	...
	@Test
	/**
	 * This testmethod tests the method divide in the class Calculator with positive random generated numbers 0-1000
	 */
	...
	@Test
	/**
	 * This testmethod tests the method divide in the class Calculator with negative random generated numbers 0 to -10
	 **/
	...
	@Test
	/**
	 * This testmethod tests the method divide in the class Calculator with negative random generated numbers 0 to -100
	 **/
	public void testDivideMediumNegativeNumbers() {
		...
		for (int i = 0; i < 200; i++) { // jag kör 200 varv
			...
			LOG.info("Testing the method divide with random numbers 0 to -100: " + firstNumber + " and " + secondNumber);
			assertEquals(Math.round(calculator.divide(firstNumber, secondNumber)), Math.round(result), 1);
	...
	@Test
	/**
	 * This testmethod tests the method divide in the class Calculator with negative random generated numbers 0 to -1000
	 **/
	public void testDivideLargeNegativeNumbers() {
		...
		for (int i = 0; i < 200; i++) { // jag kör 200 varv
			...
			LOG.info("Testing the method divide with random numbers 0 to -1000: " + firstNumber + " and " + secondNumber);
			assertEquals(Math.round(calculator.divide(firstNumber, secondNumber)), Math.round(result), 1);
	...
	@Test
	/**
	 * This testmethod tests the method divide in the class Calculator with firstNumber = 0, secondNumber random 0-100
	 **/
	public void testDivideFirstIsZero() {
		...
		for (int i = 0; i < 200; i++) { // jag kör 200 varv
			...
			LOG.info("Testing the method divide with zero and random numbers 0 to 100: " + firstNumber + " and " + secondNumber);
			assertEquals(Math.round(calculator.divide(firstNumber, secondNumber)), Math.round(result), 1);
	...
	public void testDivideSecondIsZero() {
		...
		for (int i = 0; i < 200; i++) { // jag kör 200 varv
			...
			LOG.info("Testing the method divide with random numbers 0 to 100 and zero: " + firstNumber + " and " + secondNumber);
			assertEquals(Math.round(calculator.divide(firstNumber, secondNumber)), Math.round(result), 1);
